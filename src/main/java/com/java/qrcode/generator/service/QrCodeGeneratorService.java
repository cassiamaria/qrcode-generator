package com.java.qrcode.generator.service;
...
import com.java.qrcode.generator.ports.StoragePorts;
...
public class QrCodeGeneratorService {
    ...
    public QrCodeGeneratorResponseDTO generateAndUploadQrCode(String text) throws WriterException, IOException {
        ...
        return new QrCodeGeneratorResponseDTO(url);
    }
}
